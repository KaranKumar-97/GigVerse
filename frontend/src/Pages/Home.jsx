  ...
  useEffect(() => {
    const updateSliderSettings = () => {
      ...
      if (width < 750) {
        ...
        setSliderSettings({ slidesToShow: 3, arrowsScroll: 3 });
      }
    };
    ...
    <div>
      ...
      <div className="w-[90%] mx-auto ">
        ...
        <div className="flex justify-center gap-10 flex-wrap">
          {categories.map((category,i) => (
             ...
             <img
               src={category.img}
               alt=""
               className="w-20 mb-2 transition-transform duration-300 ease-in-out hover:scale-[105%]"
             />
        ...
        <Slide {...sliderSettings}>
          {topgigs.map((card,i) => {
            return <GigCard key={i} item={card} className="" />;
          })}
        </Slide>
          </div>
