...
const Register = () => {
  ...
  return (
    <div className="">
      <div className="flex flex-col md:flex-row justify-evenly w-[90%] mt-16 mx-auto">
        ...
        <div className="flex flex-col items-center justify-center gap-5 md:min-w-[45%] ">
          ...
          <div className="w-full md:w-[50%] mx-auto space-y-5">
            <TextField fullWidth required name="fullname" label="Full Name" value={registerData.fullname} onChange={handleInput} 
             error={!!errors.fullname}
             helperText={errors.fullname}/>
            <TextField fullWidth required name="email" label="Email" value={registerData.email} onChange={handleInput}   error={!!errors.email}
      helperText={errors.email} />

            <TextField fullWidth required name="password" label="Password" type="password" value={registerData.password} onChange={handleInput}  error={!!errors.password}
            ...
            <div className="flex items-center">
              ...
              <Switch
                ...
                onChange={(e) => {
                  ...
                  setRegisterData({...registerData, isSeller: e.target.checked})
                }}
              />
            </div>
      ...
      <button className="w-[50%] md:w-[30%] mt-8 flex justify-center mx-auto bg-blue-900 py-3 text-white font-semibold rounded-lg" onClick={handleRegister}>
        Register
      </button>
    </div>
  );
