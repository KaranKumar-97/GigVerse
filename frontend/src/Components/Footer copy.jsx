      ...
      <div className="w-[90%] mx-auto">
        <div className="flex flex-col md:flex-row justify-between">
          ...
          {accordion.support && (
             <div className={`${!accordion.categories ? 'block' : 'hidden'} md:block`}>
                <p>Help & Support</p>
                <p>Trust & Safety</p>
                <p>Selling on GigVerse</p>
                <p>Buying on GigVerse</p>
              </div>
            )}
          </div>
          <div className="flex flex-col gap-2">
          ...
          {accordion.more && (
         <div className={`${!accordion.categories ? 'block' : 'hidden'} md:block`}>
              <p>GigVerse Business</p>
              <p>GigVerse Pro</p>
              <p>GigVerse Logo Maker</p>
              <p>GigVerse Guides</p>
              <p>Get Inspired</p>
              <p>GigVerse Select</p>
              <p>ClearVoice</p>
              <p>GigVerse Workspace</p>
              <p>Learn</p>
        ...
        <div className="pt-2 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-gray-500 ">
            <h2 className="font-bold text-4xl text-gray-700">GigVerse</h2>
            <p>© GigVerse International Ltd. 2024</p>
          </div>
